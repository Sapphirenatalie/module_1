...
# где a, b, c - данные которые выводятся на экран.
# Для названия переменных используйте только: латинские буквы, не начинайте запись с числа,
# пишите в змеином регистре(разделяя слова символом '_')
...
exercise_avg_time = num_hours / dz_done_qt

print('Курс: Python, всего задач:', dz_done_qt, ', затрачено часов:',num_hours,
      ', \nсреднее время выполнения: ', exercise_avg_time, 'часа')
